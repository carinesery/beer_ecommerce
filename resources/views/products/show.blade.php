<x-layout>
    <form action="" method="POST" class="flex flex-wrap gap-4 py-4 container mx-auto border">
        <div> 
        ...
        <div class="flex flex-col gap-4 border">
            <div>
                ...
                <h2 class="font-bold text-3xl">{{ $product->name }} <span>{{ $productVariant->price_without_tax/100}} €</span></h2>
